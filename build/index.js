  ...
  "node_modules/ajv/lib/ajv.js"(exports, module) {
    ...
    function setLogger(self) {
      ...
      if (logger3 === false) {
        ...
        if (logger3 === void 0) logger3 = console;
...
var package_default = {
  ...
  version: "3.0.1",
  description: "Simple, working MCP Server for Raindrop.io bookmark management",
  main: "build/simple.js",
  module: "build/simple.js",
  type: "module",
  bin: {
    "raindrop-mcp": "build/simple.js"
  },
  files: [
    "build"
  ],
  ...
  scripts: {
    ...
    build: "esbuild src/index.ts src/server.ts --bundle --platform=node --format=esm --sourcemap --outdir=build --external:@modelcontextprotocol/* --external:express --external:axios --external:dotenv --external:openapi-fetch --external:rate-limiter-flexible --external:simple-oauth2 --external:openai",
...
// src/index.ts
var logger2 = createLogger("mcp-stdio");
async function main() {
  ...
  logger2.info("MCP server connected via STDIO transport");
  process.on("SIGINT", async () => {
    logger2.info("Received SIGINT, shutting down gracefully");
    try {
      await cleanup();
      await server.close();
      logger2.info("Server shut down completed");
    } catch (error) {
